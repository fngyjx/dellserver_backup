...
my $customer_key="aHTFjoHB1CpR7jLHNnmvxg90e"; #Needs to be a valid twitter  customer_key
my $customer_secret="VQiwpr7YKXYGVFhHM1risNIl7Hk1DgMkvuiuYo1Finsq6FS3we"; #Needs to be a valid twitter customer_secret
...
$VAR1 = {
          'token_type' => 'bearer',
          'access_token' => 'AAAAAAAAAAAAAAAAAAAAAMXWdgAAAAAAHkNeBd51H02mD9yP50H%2Fu%2F2kSe8%3DU1L16ArJIJmMPmHhMNePlmGOcsksAxnboOQzQs5sfKOrxTxk8T'
        };
...
aHTFjoHB1CpR7jLHNnmvxg90e

=item Consumer secret

VQiwpr7YKXYGVFhHM1risNIl7Hk1DgMkvuiuYo1Finsq6FS3we

=back

RFC 1738 encoded consumer key (does not change) aHTFjoHB1CpR7jLHNnmvxg90e
RFC 1738 encoded consumer secret (does not change) VQiwpr7YKXYGVFhHM1risNIl7Hk1DgMkvuiuYo1Finsq6FS3we
Bearer token credentials aHTFjoHB1CpR7jLHNnmvxg90e:VQiwpr7YKXYGVFhHM1risNIl7Hk1DgMkvuiuYo1Finsq6FS3we 
Base64 encoded bearer token credentials YUhURmpvSEIxQ3BSN2pMSE5ubXZ4ZzkwZTpWUWl3cHI3WUtYWUdWRmhITTFyaXNOSWw3SGsxRGdN
...
=head2 Step 2: Obtain a bearer token
 ...
 Authorization: Basic  YUhURmpvSEIxQ3BSN2pMSE5ubXZ4ZzkwZTpWUWl3cHI3WUtYWUdWRmhITTFyaXNOSWw3SGsxRGdN
 a3Z1aXVZbzFGaW5zcTZGUzN3ZQo=
